...
function helpEmbeds() {
	const embed1 = new EmbedBuilder()
		.setAuthor({
			name: "Nimz",
			iconURL:
				"https://github.com/william2sober/Joltz-s-Image-Hosting/blob/main/Discord%20Images/Bot%20Images/Nimz-logo.png?raw=true",
		})
		.setTitle("Nimz")
		.setDescription(
			"Nimz is a Discord bot that allows you to play music on your server.\n\n" +
				" With v, you can play music from Youtube, Spotify, and SoundCloud.",
		)
		.setColor(Color.BLUE)
	...
	const embed2 = new EmbedBuilder()
		...
		.setDescription(
			"To play music, use the command '.play <song name / url>'. Nimz will join your voice channel and start playing the requested song.\n\n" +
			"Nimz will automatically search for the requested song on Youtube if no URL is provided. If you want to search on a specific platform, use the following parameters:\n\n" +
	...
	const embed3 = new EmbedBuilder()
		...
		.setDescription(
			"Nimz commands start with the default prefix '.'. This prefix can be changed with the slash command '/prefix'. Available commands are listed below.\n\n" +
	...
	const embed6 = new EmbedBuilder()
		...
		.setDescription(
			"Make sure Nimz has the necessary permissions to join voice channels and manage music playback.\n\n" +
			"If you find any bugs, you can open an ticket in my [Discord Server](https://discord.gg/nK4qRka88D).",
		)
		.setColor(Color.BLUE)
...
function getEmoji(source, embed) {
	...
	if (source.includes("youtube")) {
		emoji = "<:YouTube:1297732419566178375>"
		embed ? embed.setColor(Color.RED) : embed
	} else if (source.includes("spotify")) {
		emoji = "<:SpotifyLogo:1298439772548759592>"
		embed ? embed.setColor(Color.GREEN) : embed
	} else {
		emoji = "<:SoundCloud:1298439840328843336>"
